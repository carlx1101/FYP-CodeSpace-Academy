            ...
            @foreach ($courses as $course)
              <tr>
                ...
                <td class="table-column-ps-0">
                    <a class="d-flex align-items-center" href="{{route('courses.show', $course->id)}}">
                      <div class="flex-shrink-0">
                        <img class="avatar avatar-lg" src="{{ asset('storage/' . $course->cover_image) }}" alt="{{ $course->title }}">
                      </div>
                      <div class="flex-grow-1 ms-3">
                        <h5 class="text-inherit mb-0">{{ $course->title }}</h5>
                      </div>
                    </a>
                  </td>
                ...
                <td>
                    @if($course->publishing_status == 1)
                    <span class="legend-indicator bg-success"></span>Active
                    @else
                        <span class="legend-indicator bg-gray"></span>Inactive
                    @endif
                </td>
