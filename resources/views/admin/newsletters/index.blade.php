          ...
          <div class="col-sm mb-2 mb-sm-0">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-no-gutter">
                ...
                <li class="breadcrumb-item"><a class="breadcrumb-link" href="javascript:;">Newsletter</a></li>
                <li class="breadcrumb-item active" aria-current="page">Overview</li>
              </ol>
            </nav>

            <h1 class="page-header-title">Newsletter Subscribers</h1>
          </div>
          <!-- End Col -->
          ...
          <div class="card h-100">
            <div class="card-body">
              ...
              <div class="row align-items-center gx-2">
                <div class="col">
                  <span class="js-counter display-4 text-dark">{{$newsletters->count()}}</span>
          ...
          <div class="mb-2 mb-md-0">
            <form>
              ...
              <div class="input-group input-group-merge input-group-flush">
                ...
                <input id="datatableSearch" type="search" class="form-control" placeholder="Search subscriber" aria-label="Search users">
              </div>
              <!-- End Search -->
            </form>
          </div>
                ...
                <tr>
                    ...
                    <td class="table-column-ps-0">
                        <a class="d-flex align-items-center" href="./user-profile.html">
                            ...
                            <div class="ms-3">
                                <span class="d-block fs-5 text-body">{{ $newsletter->email }}</span>
                            </div>
                        </a>
                    </td>
                    ...
                    <td>{{ $newsletter->created_at ? $newsletter->created_at->format('M d, Y') : 'N/A' }}</td>
