        ...
        <div class="row align-items-center">
          <div class="col-sm mb-2 mb-sm-0">
            ...
            <div class="d-sm-flex align-items-sm-center mb-4">
                <h1 class="page-header-title">Order #{{ $sale->id }}</h1>
                <span class="badge bg-soft-{{ $sale->status == 'completed' ? 'success' : 'danger' }} text-{{ $sale->status == 'completed' ? 'success' : 'danger' }} ms-sm-3">
                    <span class="legend-indicator bg-{{ $sale->status == 'completed' ? 'success' : 'danger' }}"></span>{{ ucfirst($sale->status) }}
                </span>
                <span class="ms-2 ms-sm-3">
                    <i class="bi-calendar-week"></i> {{ $sale->created_at->format('M d, Y, h:i A') }}
                </span>
            </div>
        ...
        <div class="col-lg-8 mb-3 mb-lg-0">
            ...
            <div class="card mb-3 mb-lg-5">
                ...
                <div class="card-header card-header-content-between">
                    <h4 class="card-header-title">Order details <span class="badge bg-soft-dark text-dark rounded-circle ms-1">{{ $sale->orderItems->count() }}</span></h4>
                    ...
                    <div class="d-flex">
                        <div class="flex-shrink-0">
                            <div class="avatar avatar-xl">
                                <img class="img-fluid" src="{{ asset('storage/' . $item->course->cover_image) }}" alt="{{ $item->course->title }}">
                            </div>
                        </div>
                        ...
                        <div class="flex-grow-1 ms-3">
                            <div class="row">
                                <div class="col-md-6 mb-3 mb-md-0">
                                    <a class="h5 d-block" href="#">{{ $item->course->title }}</a>

                                    <div class="fs-6 text-body">
                                        <span>Category:</span>
                                        <span class="fw-semibold">{{ $item->course->category->name }}</span>
                                    </div>
                                    <div class="fs-6 text-body">
                                        <span>Subcategory:</span>
                                        <span class="fw-semibold">{{ $item->course->subcategory->name }}</span>
                                    </div>
                                </div>
                                <!-- End Col -->

                                <div class="col col-md-2 align-self-center">
                                    <h5>RM {{ number_format($item->price, 2) }}</h5>
                                </div>
                                <!-- End Col -->
                    ...
                    <div class="row justify-content-md-end mb-3">
                        <div class="col-md-8 col-lg-7">
                            <dl class="row text-sm-end">
                                ...
                                <dd class="col-sm-6">RM {{ number_format($sale->total, 2) }}</dd>
                                <dt class="col-sm-6">Shipping fee:</dt>
                                <dd class="col-sm-6">RM 0.00</dd>
                    ...
                    <ul class="list-group list-group-flush list-group-no-gutters">
                        <li class="list-group-item">
                            <a class="d-flex align-items-center" href="#">
                                <div class="avatar avatar-circle">
                                    <img class="avatar-img" src="{{ $sale->user->profile_photo_path ? asset('storage/' . $sale->user->profile_photo_path) : asset('default-avatar.jpg') }}" alt="Image Description">
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <span class="text-body text-inherit">{{ $sale->user->name }}</span>
                                </div>
                        ...
                        <li class="list-group-item">
                            ...
                            <ul class="list-unstyled list-py-2 text-body">
                                <li><i class="bi-at me-2"></i>{{ $sale->user->email }}</li>
                                <li><i class="bi-phone me-2"></i>{{ $sale->user->profile->phone }}</li>
                            </ul>
                        </li>
                        ...
                        <li class="list-group-item">
                            ...
                            <span class="d-block text-body">
                                {{ $sale->user->profile->address_line_one}}<br>
                                {{ $sale->user->profile->address_line_two}}<br>
                                {{ $sale->user->profile->state}}
                                {{ $sale->user->profile->zipcode}}<br>
                                {{ $sale->user->profile->country}}<br>

                            </span>

                            <div class="mt-3">
                                <h5 class="mb-0">Payment Method</h5>
                                <span class="d-block text-body">{{$sale->payment_method}}</span>
                            </div>
                        </li>
                    </ul>
                    <!-- End List Group -->
