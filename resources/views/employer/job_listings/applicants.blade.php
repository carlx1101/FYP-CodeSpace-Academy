          ...
          <div class="col-sm mb-2 mb-sm-0">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-no-gutter">
                ...
                <li class="breadcrumb-item"><a class="breadcrumb-link" href="javascript:;">Applicants</a></li>
      ...
      <div class="row">
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
          ...
          <div class="card h-100">
            <div class="card-body">
              <h6 class="card-subtitle mb-2">Total Applicants</h6>

              <div class="row align-items-center gx-2">
                <div class="col">
                  <span class="js-counter display-4 text-dark">{{$applicants->count()}}</span>
                ...
                <tr>
                    ...
                    <td>{{ $applicant->created_at->format('Y-m-d H:i') }}</td>
                        ...
                        <td>
                            ...
                            <a href="{{ route('user.public_preview', Crypt::encryptString($applicant->user->id)) }}" class="btn btn-info btn-sm">Portfolio</a>
