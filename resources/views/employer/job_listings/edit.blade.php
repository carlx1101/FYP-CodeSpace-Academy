            ...
            <div class="col-sm mb-2 mb-sm-0">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-no-gutter">
                        <li class="breadcrumb-item"><a class="breadcrumb-link" href="{{ route('employer.job_listings.index') }}">Listings</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Add Listing</li>
                    </ol>
                </nav>

                <h1 class="page-header-title">Add Listing</h1>
            </div>
        </div>
    </div>
    <!-- End Page Header -->
        ...
        <div class="col-lg-8 mb-3 mb-lg-0">
            ...
            <div class="card mb-3 mb-lg-5">
                ...
                <div class="card-header">
                    <h4 class="card-header-title">Listing information</h4>
                </div>
                <!-- End Header -->
                ...
                <div class="card-body">
                    <!-- Form -->
                    <form action="{{ route('employer.job_listings.store') }}" method="POST">
                        @csrf
                        <div class="mb-4">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <h1 class="page-header-title">Edit Listing</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
        ...
        <div class="row">
            <div class="col-lg-8 mb-3 mb-lg-0">
                ...
                <div class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        <!-- Form -->
                        <form action="{{ route('employer.job_listings.update', $jobListing->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="mb-4">
                                <label for="title" class="form-label">Title</label>
                                <input type="text" class="form-control" id="title" name="title" value="{{ old('title', $jobListing->title) }}">
                            </div>
                            <!-- End Form -->
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="mb-4">
                                        <label for="type" class="form-label">Job Type</label>
                                        <select class="js-select form-select" id="type" name="type" autocomplete="off"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="mb-4">
                                        <label for="mode" class="form-label">Mode</label>
                                        <select class="js-select form-select" id="mode" name="mode" autocomplete="off"
                                            data-hs-tom-select-options='{
                                                "placeholder": "Select a mode...",
                                                "hideSearch": true
                                            }'>
                                            <option value="">Select a mode...</option>
                                            <option value="Onsite" {{ old('mode', $jobListing->mode) == 'Onsite' ? 'selected' : '' }}>Onsite</option>
                                            <option value="Hybrid" {{ old('mode', $jobListing->mode) == 'Hybrid' ? 'selected' : '' }}>Hybrid</option>
                                            <option value="Remote" {{ old('mode', $jobListing->mode) == 'Remote' ? 'selected' : '' }}>Remote</option>
                                        </select>
                                    </div>
                                    <!-- End Form -->
                                </div>
                            ...
                            <label class="form-label">Description <span class="form-label-secondary">(Optional)</span></label>
                            <!-- Quill -->
                            <div class="quill-custom mb-4">
                                <textarea class="form-control" id="description" name="description" rows="4">{{ old('description', $jobListing->description) }}</textarea>
                            </div>
                            <!-- End Quill -->
