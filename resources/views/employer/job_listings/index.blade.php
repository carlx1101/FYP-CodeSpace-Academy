          ...
          <div class="col-sm mb-2 mb-sm-0">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-no-gutter">
                ...
                <li class="breadcrumb-item"><a class="breadcrumb-link" href="javascript:;">Listings</a></li>
                <li class="breadcrumb-item active" aria-current="page">Overview</li>
              </ol>
            </nav>

            <h1 class="page-header-title">Listings</h1>
          </div>
          <!-- End Col -->

          <div class="col-sm-auto">
            <a class="btn btn-primary" href="{{route('employer.job_listings.create')}}">
              <i class="bi-person-plus-fill me-1"></i> Add Listing
            </a>
          </div>
          <!-- End Col -->
        </div>
      ...
      <div class="row">
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
          ...
          <div class="card h-100">
            <div class="card-body">
              <h6 class="card-subtitle mb-2">Total Listing</h6>

              <div class="row align-items-center gx-2">
                <div class="col">
                  <span class="js-counter display-4 text-dark">{{$jobListings->count()}}</span>
                ...
                <tr>
                    ...
                    <td class="table-column-ps-0">
                        <a class="d-flex align-items-center" href="./user-profile.html">
                            ...
                            <div class="ms-3">
                                <span class="d-block h5 text-inherit mb-0">{{ $jobListing->title }}</span>
                            </div>
                        </a>
                    </td>
