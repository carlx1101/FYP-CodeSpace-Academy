...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
          ...
          <div class="col-sm mb-2 mb-sm-0">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-no-gutter">
                <li class="breadcrumb-item"><a class="breadcrumb-link" href="javascript:;">Account & Setting</a></li>
                <li class="breadcrumb-item active" aria-current="page">Billing History</li>
              </ol>
            </nav>

            <h1 class="page-header-title">Billing History</h1>
          </div>
          <!-- End Col -->
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="text-center mb-5">
            <h3 class="mb-1">Invoice from CodeSpace</h3>
  ...
  <script src="{{asset('backend/vendor/hs-toggle-switch/dist/hs-toggle-switch.min.js')}}"></script>
