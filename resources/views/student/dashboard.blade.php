      ...
      <div class="row">
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
          ...
          <a class="card card-hover-shadow h-100" href="#">
            <div class="card-body">
              <h6 class="card-subtitle">Total Course</h6>

              <div class="mt-3">
                <h1 style="font-size: 40px">{{$courses->count()}}</h1>
              </div>
              <!-- End Row -->
        ...
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
            ...
            <a class="card card-hover-shadow h-100" href="#">
              <div class="card-body">
                ...
                <div class="mt-3">
                  <h1 style="font-size: 40px">{{$orders->count()}} </h1>
                </div>
                <!-- End Row -->
        ...
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
            ...
            <a class="card card-hover-shadow h-100" href="#">
              <div class="card-body">
                <h6 class="card-subtitle">Total Completed Courses</h6>

                <div class="mt-3">
                  <h1 style="font-size: 40px">{{ $totalCompletedCourses }} </h1>
                </div>
                <!-- End Row -->
        ...
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
            ...
            <a class="card card-hover-shadow h-100" href="#">
              <div class="card-body">
                ...
                <div class="mt-3">
                  <h1 style="font-size: 40px">{{ $totalCompletedLessons }} </h1>
                </div>
                <!-- End Row -->
        ...
        <div class="col-lg-5 mb-3 mb-lg-5">
          ...
          <div class="card h-100">
            ...
            <div class="card-header card-header-content-between">
              <h4 class="card-header-title">My Courses</h4>
                    ...
                    <li class="list-group-item">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <div class="col">
                                ...
                                <span class="d-block fs-6 text-body">{{ $course->category->name }}</span>
                            </div>
                            <!-- End Col -->

                            <div class="col-auto">
                                <a class="btn btn-primary btn-sm" href="{{ route('student.learn', ['courseTitle' => $course->title]) }}" title="Launch course" target="_blank">
                                Learn <span class="d-none d-sm-inline-block">course</span>
            ...
            <div class="card h-100">
              ...
              <div class="card-header card-header-content-sm-between">
                ...
                <ul class="nav nav-segment nav-fill" id="expensesTab" role="tablist">
                  <li class="nav-item" data-bs-toggle="chart-bar" data-datasets="thisYear" data-trigger="click" data-action="toggle">
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-sm-auto align-self-sm-end">
                    <div class="row fs-6 text-body">
                      <div class="col-auto">
                        <span class="legend-indicator bg-primary"></span> Expenses
                      </div>
                    </div>
                    <!-- End Row -->
                  </div>
