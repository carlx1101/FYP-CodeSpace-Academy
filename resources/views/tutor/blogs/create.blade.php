                ...
                <div class="card-body">
                    ...
                    <form id="postForm">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" name="subtitle" id="subtitleLabel" placeholder="Subtitle">
                        </div>

                        <div class="mb-4">
                            <label for="tagsLabel" class="form-label">Tags</label>
                            <input type="text" class="form-control" name="tags" id="tagsLabel" placeholder="Separate with commas">
                        </div>

                        <div class="mb-4">
                            <label class="form-label">Content</label>
                            <div class="quill-custom">
                                <div class="js-quill" id="contentEditor" style="height: 15rem;"></div>
                            </div>
                        </div>
...
document.getElementById('postForm').addEventListener('submit', function(e) {
    ...
    let content = document.querySelector('#contentEditor').__quill.root.innerHTML;
    formData.append('content', content);

    let coverDropzoneElement = document.querySelector('#coverDropzone').dropzone;

    if (coverDropzoneElement && coverDropzoneElement.files.length > 0) {
        let post_cover = coverDropzoneElement.files[0];
