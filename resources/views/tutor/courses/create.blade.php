        ...
        <div id="basicVerStepIntendedLearners" class="card card-body active" style="min-height: 15rem;">
            ...
            <hr>
                ...
                <div class="js-add-field row mb-4"
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="js-input-mask form-control" name="learning_objectives[]" id="learningObjective" placeholder="Enter Learning Objective" >

                        <!-- Container For Input Field -->
                        <div id="addLearningObjectiveFieldContainer"></div>

                            <a href="javascript:;" class="js-create-field form-link">
                                <i class="bi-plus-circle me-1"></i> Add Learning Objective
                            </a>
                        </div>
                    </div>
                    <!-- End Form -->
                ...
                <div class="js-add-field row mb-4"
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="js-input-mask form-control" name="prerequisites[]" id="prerequisites" placeholder="Enter Prerequisites" aria-label="Enter Prerequisites">

                        <!-- Container For Input Field -->
                        <div id="addPrerequisitesFieldContainer"></div>

                        <a href="javascript:;" class="js-create-field form-link">
                            <i class="bi-plus-circle me-1"></i> Add Prerequisite
                        </a>
                    </div>
                </div>
                <!-- End Form -->
                ...
                <div class="js-add-field row mb-4"
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="js-input-mask form-control" name="target_audiences[]" id="target_audiences" placeholder="Enter Target Audience" aria-label="Enter Target Audience">

                        <!-- Container For Input Field -->
                        <div id="addTargetAudienceFieldContainer"></div>

                        <a href="javascript:;" class="js-create-field form-link">
                            <i class="bi-plus-circle me-1"></i> Add Target Audience
                        </a>
                    </div>
                </div>
                <!-- End Form -->
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="primary_language" id="primaryLanguage" placeholder="Language">
                    </div>
                </div>
                <!-- End Form -->
