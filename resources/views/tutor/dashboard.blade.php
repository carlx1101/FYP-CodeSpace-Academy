      ...
      <div class="row">
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
            ...
            <a class="card card-hover-shadow h-100" href="#">
              <div class="card-body">
                <h6 class="card-subtitle">Total courses published</h6>

                <div class="mt-3">
                  <h1 style="font-size: 40px">{{ $totalCourses }} </h1>
                </div>
                <!-- End Row -->
        ...
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
            ...
            <a class="card card-hover-shadow h-100" href="#">
              <div class="card-body">
                ...
                <div class="mt-3">
                  <h1 style="font-size: 40px">{{ $totalBlogPosts }} </h1>
                </div>
                <!-- End Row -->
        ...
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
            ...
            <a class="card card-hover-shadow h-100" href="#">
              <div class="card-body">
                ...
                <div class="mt-3">
                  <h1 style="font-size: 40px">{{ $totalEvents }} </h1>
                </div>
                <!-- End Row -->
        ...
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
            ...
            <a class="card card-hover-shadow h-100" href="#">
              <div class="card-body">
                ...
                <div class="mt-3">
                  <h1 style="font-size: 40px">RM {{ $totalSales }} </h1>
                </div>
                <!-- End Row -->
        ...
        <div class="col-lg-12 mb-3 mb-lg-5">
            ...
            <div class="card h-100">
              ...
              <div class="card-header card-header-content-sm-between">
                <h4 class="card-header-title mb-2 mb-sm-0">Monthly sales</h4>
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-sm-auto align-self-sm-end">
                    <div class="row fs-6 text-body">
                      <div class="col-auto">
                        <span class="legend-indicator bg-primary"></span> Sales
                      </div>
                    </div>
                    <!-- End Row -->
                  </div>
